"""
Django settings for shrill_union_43092 project.
...
ROOT_URLCONF = 'shrill_union_43092.urls'
...
WSGI_APPLICATION = 'shrill_union_43092.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_union_43092 API",
    "DESCRIPTION": "API documentation for shrill_union_43092 App",
    "VERSION": "v1",
}
